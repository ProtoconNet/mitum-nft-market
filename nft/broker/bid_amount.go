...
var (
	...
	BidNFTHinter     = BidNFT{BaseOperation: operationHinter(BidNFTHint)}
)
...
func NewBidNFTFact(token []byte, sender base.Address, broker nft.Symbol, nftid nft.NFTID, amount currency.Amount) BidNFTFact {
	fact := BidNFTFact{
