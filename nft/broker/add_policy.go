...
func NewAddUserDefinedPolicyFact(token []byte, sender base.Address, target base.Address, policy BrokerPolicy, cid currency.CurrencyID) AddUserDefinedPolicyFact {
...
func (fact AddUserDefinedPolicyFact) Policy() BrokerPolicy {
	return fact.policy
}
